...
class ReceivedTransitionScene extends Component {
  ...
  onNavigatePress = () => {
    this.props.navigation.navigate('SendTransition');
  };
  ...
  renderNavigateButton() {
    return (
      <MyButton
        ...
        title={I18n.t('OUTPUT_TRANSITION')}
        containerStyle={{
...
export default connect(mapStateToProps, null)(ReceivedTransitionScene);